 ...
 * <ul>
 *   <li>{@link org.camunda.bpm.modeler.runtime.engine.model.casOpen.impl.OutputPropertyImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.camunda.bpm.modeler.runtime.engine.model.casOpen.impl.OutputPropertyImpl#getPropertyType <em>Property Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutputPropertyImpl extends PropertyImpl implements OutputProperty {
	/**
	...
	protected EClass eStaticClass() {
		return CasOpenPackage.Literals.OUTPUT_PROPERTY;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CasOpenPackage.OUTPUT_PROPERTY__DESCRIPTION, oldDescription, description));
	}
	...
	public void setPropertyType(String newPropertyType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CasOpenPackage.OUTPUT_PROPERTY__PROPERTY_TYPE, oldPropertyType, propertyType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CasOpenPackage.OUTPUT_PROPERTY__DESCRIPTION:
				return getDescription();
			case CasOpenPackage.OUTPUT_PROPERTY__PROPERTY_TYPE:
